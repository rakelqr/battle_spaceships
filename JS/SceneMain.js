  ...
  //      this.load.image(imageKey, path);
    ...
    create() {
        ...
        this.time.addEvent({
            delay: 3000,
            callback: () => {
                console.log("timer callback", new Date().getTime());
                var enemy = null;

                if (Phaser.Math.Between(0, 10) >= 3) {
                    console.log("creating gunship");
                    enemy = new GunShip(
                        this,
...
// https://github.com/rakelqr/battle_spaceships.git
//git remote add origin https://github.com/rakelqr/battle_spaceships.git