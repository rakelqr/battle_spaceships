...
class ScrollingBackground {
    ...
    createLayers() {
        //console.log("ScrollingBackground.createLayers()");
        for (var i = 0; i < 2; i++) {
            ...
            //console.log("adding layer " + i, layer);
            this.layers.add(layer);
          }
    }

    update = () => {
        //console.log("ScrollingBackground.update()");
        let children = this.layers.getChildren();
